...
export default function CommonModal({ children, onClose, title }: Props) {
  const element = typeof window !== 'undefined' && document.querySelector(portalSelector);
  return element && children
    ? ReactDOM.createPortal(
        <div className="fixed left-0 top-0 z-[100] flex h-full w-full items-center justify-center bg-black bg-opacity-30">
