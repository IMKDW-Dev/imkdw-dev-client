...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@/_shadcn/components/ui/sheet';
import { Skeleton } from '@/_shadcn/components/ui/skeleton';
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@/_shadcn/components/ui/tooltip';
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 font-extrabold',
        className,
      )}
      {...props}
    />
